...
public class Barbaro {
    ...
    public void atacar(Guerreiro guerreiro, Armas armas) {
        if(vida<=0){System.out.println("Um personagem morto atacou e ataque será ignorado. "
                +nome + " atacou " + guerreiro.nome + " com " + armas.nome+" sem causar danos.");
                    return;}
        double ataqueFinal = armas.poder * ataque;
    ...
    public void atacar(Barbaro barbaro, Armas armas) {
        if(vida<=0){System.out.println("Um personagem morto atacou e ataque será ignorado. "
                +nome + " atacou " + barbaro.nome + " com " + armas.nome+" sem causar danos.");
                    return;}
        double ataqueFinal = armas.poder * ataque;
        double dano = ataqueFinal - barbaro.defesa;
        barbaro.vida = barbaro.vida - 1;
        if(barbaro.vida==0){System.out.print(barbaro.nome+" morreu no ataque!!! ");}
        if(barbaro.vida<0){
    ...
    public void atacar(Clerigo clerigo, Armas armas) {
        if(vida<=0){System.out.println("Um personagem morto atacou e ataque será ignorado. "
                +nome + " atacou " + clerigo.nome + " com " + armas.nome+" sem causar danos.");
    ...
    public void atacar(Mago mago, Armas armas) {
        if(vida<=0){System.out.println("Um personagem morto atacou e ataque será ignorado. "
                +nome + " atacou " + mago.nome + " com " + armas.nome+" sem causar danos.");
            return;}//Ataques de personagens mortos devem ser ignorados
        double ataqueFinal = armas.poder* ataque;
    ...
    public void atacar(Feiticeiro feiticeiro, Armas armas) {
        if(vida<=0){System.out.println("Um personagem morto atacou e ataque será ignorado. "
                +nome + " atacou " + feiticeiro.nome + " com " + armas.nome+" sem causar danos.");
            return;}//Ataques de personagens mortos devem ser ignorados
        double ataqueFinal = armas.poder* ataque;
