...
public class Clerigo {
    ...
    public void atacar(Guerreiro guerreiro, PoderesDivinos poderesDivinos) {
        ...
        if(guerreiro.vida==0 && fe>0){System.out.print(guerreiro.nome+" morreu no ataque!!! ");}//Quando um ataque resultar na morte do alvo, isso deve ser impresso no registro do ataque
        if(guerreiro.vida<0){
